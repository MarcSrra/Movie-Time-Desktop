...
namespace DesktopWireframe
{
    public partial class MenuAdmin : Form
    {
        ...
        */
        ...
        {
            EditarUsuariosAdmin usuarios = new EditarUsuariosAdmin() {Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
            this.panelForm.Controls.Clear();
        ...
        //Carga la pantalla de gestionar jugadores en el panel
